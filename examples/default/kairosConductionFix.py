...
from pyrk import th_componentFix as th
import math
...
# KAIROS TODO conduction placeholder values
k_fuel = 31.4 * units.watt / units.meter / units.kelvin
k_mod = 26.3 * units.watt / units.meter / units.kelvin
k_core = 26.3 * units.watt / units.meter / units.kelvin
...
# KAIROS = 320 MWth
power_tot = 320000000.0 * units.watt
...
fuel.add_conduction('mod', k=k_fuel, area=a_fuel, thickness=4 * units.millimeter)

# The moderator graphite conducts to the core graphite
mod.add_conduction('core', k=k_mod, area=a_core, thickness=25 * units.millimeter)
# The moderator graphite conducts to the fuel
mod.add_conduction('fuel', k=k_mod, area=a_mod, thickness=25 * units.millimeter)
...
core.add_conduction('mod', k=k_core, area=a_core, thickness=25 * units.centimeter)
